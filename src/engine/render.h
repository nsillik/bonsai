...
link_internal void
RenderToTexture_gpu_mapped_element_buffer(engine_resources *Engine, asset_thumbnail *Thumb, gpu_mapped_element_buffer *Src, v3 Offset, camera *Camera = 0);

link_internal void
RenderToTexture_gpu_heap_allocation(engine_resources *Engine, asset_thumbnail *Thumb, gpu_heap_allocation *Src, v3 Offset, camera *Camera = 0);
